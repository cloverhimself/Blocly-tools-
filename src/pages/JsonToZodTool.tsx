...
export function JsonToZodTool() {
  ...
  try {
    if (input.trim() === "") {
      ...
      output = "import { z } from \"zod\";\n\nexport const schema = " + jsonToZod(parsed) + ";\n";
    }
  } catch (e: any) {
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-5 py-10 flex flex-col">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="m-0 font-extrabold text-2xl tracking-[-0.01em]">JSON to Zod</h1>
          </div>
          <p className="text-[#111111]/60 text-sm">Convert JSON objects to Zod schemas</p>
        </div>
