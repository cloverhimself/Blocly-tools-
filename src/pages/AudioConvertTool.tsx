...
export function AudioConvertTool() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const args = ["-i", inputName, "-acodec", acodec];
      if (format !== 'WAV') {
      ...
      <main className="flex-1">
        <div className="max-w-5xl mx-auto px-5 py-10 md:py-14">
          <div className="font-mono text-[12px] text-[#111111]/60 mb-6">
            ...
            <span className="text-[#111111]/40 mx-2">/</span>
            <span className="text-[#111111]">Convert Audio</span>
          </div>
          ...
          <p className="mt-4 mb-8 text-[16px] leading-[1.5] text-[#111111]/66 max-w-[62ch]">
            Cross-convert audio files to standard formats like MP3, WAV, AAC, and OGG instantly on your device via client-side WebAssembly execution.
          </p>
              ...
              <div className="flex-1 min-w-[280px] border border-[#111111] rounded-sm p-5 box-border flex flex-col justify-center gap-3.5 min-h-[182px]">
                ...
                {mode === 'processing' && (
                  <>
                    ...
                    <div className="font-mono text-[11.5px] text-[#111111]/55 mt-1">
                      Encoding audio track to {format} - {format !== 'WAV' ? `${quality} kbps` : 'Lossless'}
                    </div>
                  </>
                )}
