    ...
    <header className="w-full border-b border-[#111111] bg-[#FAFAFA]">
      <div className="max-w-7xl mx-auto px-5 h-[62px] flex items-center justify-between gap-3.5">
        ...
        <nav className="flex items-center gap-4">
          <Link
            to="/"
            className="text-[#111111] text-[13.5px] font-semibold border-b-2 border-transparent pb-[1px] hover:border-[#FFD400]"
          >
            Tools
          </Link>
          <a
          ...
          <a
            ...
            className="flex items-center gap-2 text-[#111111] text-[13.5px] font-semibold border border-[#111111] rounded-sm px-3 py-1.5 hover:bg-[#FFD400] transition-colors"
          >
