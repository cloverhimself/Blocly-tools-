...
export function ToolCard({
    ...
    return (
      <div className="flex flex-col gap-3 p-[18px] pb-5 bg-white border border-[#111111]/20 rounded-sm text-[#111111] h-full min-h-[132px] opacity-40 blur-[1px] pointer-events-none select-none relative">
        <div className="flex items-center justify-between">
          <span className="block w-[26px] h-[26px] text-[#111111]">
            {iconEl}
          </span>
        </div>
        <div className="flex-1 flex flex-col justify-end">
          <div className="font-bold text-[15.5px] leading-tight tracking-tight mt-1">
            {label}
          </div>
          <div className="text-[12.5px] leading-[1.45] text-[#111111]/60 -mt-1">
            {desc}
          </div>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <span className="block w-[26px] h-[26px] text-[#111111] transition-transform group-hover:scale-110 group-hover:text-[#FFD400] drop-shadow-sm">
          {iconEl}
        </span>
        {featured && (
      ...
      <div className="flex-1 flex flex-col justify-end mt-1">
        <div className="font-bold text-[15.5px] leading-tight tracking-tight">
          {label}
        </div>
        <div className="text-[12.5px] leading-[1.45] text-[#111111]/60">
          {desc}
        </div>
      </div>
      {cloud && (
