...
export const toolRegistry: Record<string, ToolDefinition> = {
  ...
  testDataGenerator: {
    ...
    category: "Developer",
    description: "Generate flat fake records as JSON, CSV, SQL or YAML",
  ...
  mockApiGenerator: {
    ...
    category: "Developer",
    description: "Realistic nested JSON API responses to practice parsing",
    route: "/tools/mock-api",
    status: "stable",
    keywords: ["mock", "api", "json", "fake", "nested", "practice", "learn", "response", "faker", "simulate"],
    iconName: "Webhook",
  },
  jsonFormatter: {
    id: "jsonFormatter",
